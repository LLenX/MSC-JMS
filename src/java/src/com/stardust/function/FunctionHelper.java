...
public class FunctionHelper {
    ...
    public static <ReturnType> ReturnType invoke(function<ReturnType> f, Method targetMethod, Object[] args) throws InvocationTargetException, IllegalAccessException {
    ...
    public static Method getTargetMethod(@SuppressWarnings("rawtypes") Class<? extends function> functionClass, Object[] args, boolean isArgumentPassStrict) {
