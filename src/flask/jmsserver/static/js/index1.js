$(function () {
    ...
    var checkboxPrepare = function(){
        ...
        $("input[type='checkbox']").on("change", function() {
            $select = $(this).next().next();
            
            if ($(this).is(":checked"))
                $select.find("select:first").removeAttr("disabled").selectpicker('refresh');
            else {
                ...
                $select.find("select").attr("disabled", "disabled").selectpicker("render");
            }
        });
    }
    ...
    var allSelectPrepare = function(){
        ...
        $("select").on("change", function() {
            ...
            if ($selected_option.text() == "请选择") {
                ...
                $selects_after.selectpicker("render");
            }
            else {
                $select_after = $(this);
    ...
    var firstSelectPrepare = function(){
        ...
        $(".form-group:nth-of-type(1)").find("select").on("change", function() {
            ...
            $fourth_select.selectpicker("render");
